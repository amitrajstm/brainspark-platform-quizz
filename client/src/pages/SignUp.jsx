...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <section>
        <h1 className="text-center pb-5 text-4xl font-semibold text-green-600">
          BrainSpark
        </h1>
        <form
        ...
        >
          ...
          {/* <label htmlFor="user-admin"> Select Your Role</label> */}
          <span className="flex border flex-none border-slate-600 p-1 cursor-pointer w-max gap-3 rounded-full">
            <button
              name="user-admin"
              type="button"
              className={`${
